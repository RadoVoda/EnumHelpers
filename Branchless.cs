...
public static partial class Branchless
{
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int IfElse(this binary binary, int one, int zero)
    {
        return (one * binary) + (zero * !binary);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ulong IfElse(this binary binary, ulong one, ulong zero)
    {
        return (one * binary) + (zero * !binary);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T IfElse<T>(this binary binary, T one, T zero) where T : unmanaged, Enum
    {
        return ((one.ToMask() * binary) + (zero.ToMask() * !binary)).ToEnum<T>();
    }
